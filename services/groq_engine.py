...
7. DIET ENFORCEMENT — this is mandatory:
   - If diet is "vegetarian": NO eggs, NO meat, NO fish, NO chicken, NO seafood in ANY meal
   - If diet is "eggetarian": eggs allowed, but NO meat, NO fish, NO chicken, NO seafood
   - If diet is "non-vegetarian": all foods allowed
   Violating the diet rule makes the entire plan invalid.
